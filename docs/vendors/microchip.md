...
4. Get a current summary of your IoT things and certificates as follows: ```scripts/get-iot-summary.sh <aws region> ```
...
10. Verify that the operation has been succesful (correct number of certificates added, etc.) by getting the updated summary as follows: ```scripts/get-iot-summary.sh <aws region> ```
